...
@section('content')
    <div class="page-content container-fluid">
        <form role="form" action="@if(isset($dataTypeContent->id)){{ route('streams.posts.update', $dataTypeContent->id) }}@else{{ route('streams.posts.store') }}@endif" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="streams-character"></i> Post Title
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <div class="panel-actions">
                                <a class="panel-action streams-resize-full" data-toggle="panel-fullscreen" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id">
                                    @foreach(RAD\Streams\Models\Category::all() as $category)
                    ...
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                            @if(isset($dataTypeContent->image))
                                <img src="{{ Streams::image( $dataTypeContent->image ) }}" style="width:100%" />
                            @endif
